...
import com.sample.keepfamily.model.UserModel;
...
public class ParSignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        age = (EditText) findViewById(R.id.signup_edt_age);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseAuth.getInstance()
                        ...
                        .addOnCompleteListener(ParSignUpActivity.this, new OnCompleteListener<AuthResult>() {
                            @Override
